...
// app/signup/page.js — EXRAY Signup
// Theme: #080C10 bg · #7DD3F0 ice · Syne + DM Sans
        ...
        <div style={{ width: "100%", maxWidth: 400 }}>
          ...
          <div style={{ background: SURFACE, border: `1px solid ${BORDER}`, borderRadius: 12, padding: "32px 28px" }}>
            ...
            <p style={{ color: MUTED, fontSize: 13, marginBottom: 24, fontFamily: BODY }}>
              Start X-raying Etsy competitors — free
            </p>
            ...
            <div style={{ display: "flex", justifyContent: "center", gap: 20, marginTop: 20, flexWrap: "wrap" }}>
              {["5 free searches/day", "No credit card", "Cancel anytime"].map(t => (
                <span key={t} style={{ display: "flex", alignItems: "center", gap: 5, fontSize: 11, color: MUTED, fontFamily: BODY }}>
                  <span style={{ color: ICE, fontWeight: 700 }}>✓</span> {t}
                </span>
              ))}
            </div>
 
            <p style={{ textAlign: "center", fontSize: 13, color: MUTED, marginTop: 20, fontFamily: BODY }}>
              Already have an account?{" "}
              <Link href="/login" style={{ color: ICE, textDecoration: "none", fontWeight: 600 }}>
                Log in
              </Link>
            </p>
          </div>
